...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('qc_uav_photos', function (Blueprint $table) {
            // Kolom Status Revisi
            $table->boolean('has_major_revision')->default(0)->after('file_gsd');
            ...
            $table->string('rev_file_quality')->nullable();
            $table->string('rev_file_geotag')->nullable();
            $table->string('rev_file_blur')->nullable();
            $table->string('rev_file_overlap')->nullable();
            $table->string('rev_file_gsd')->nullable();
    ...
    public function down(): void
    {
        Schema::table('qc_uav_photos', function (Blueprint $table) {
            ...
            $table->dropColumn(['has_major_revision', 'rev_file_quality', 'rev_file_geotag', 'rev_file_blur', 'rev_file_overlap', 'rev_file_gsd', 'rev_qc_date', 'rev_qc_officer_name']);
