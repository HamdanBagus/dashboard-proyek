<x-app-layout>
    ...
    <div class="py-12 mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 text-sm mb-2">
                ...
                <div class="space-y-4 bg-gray-50 p-5 rounded-lg border border-gray-200">
                    ...
                    <div class="pt-3 border-t border-gray-200">
                        <label class="block text-xs font-bold text-gray-500 mb-2 uppercase tracking-wider">Kamera Yang Digunakan (Rencana)</label>
                        <div class="flex flex-wrap gap-2">
                            @php
        ...
        <form action="{{ route('projects.qc.uav_photo.update', $project->id) }}" method="POST" enctype="multipart/form-data" class="space-y-6" x-data="{ hasRevision: '{{ $qc->has_major_revision ?? 0 }}' }">
            @csrf
