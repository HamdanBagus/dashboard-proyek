<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <a href="{{ route('projects.qc.index', $project->id) }}" class="text-yellow-600 hover:underline">Formulir & QC</a>
    ...
    <div class="py-12 max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
        ...
        <form action="{{ route('projects.qc.uav_lidar.update', $project->id) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            @csrf
            ...
            <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm mb-4">
                    ...
                    <div class="space-y-4">
                        <div>
                            <label class="block text-xs font-bold text-gray-700 mb-1">UAV Yang Digunakan (Bisa pilih > 1)</label>
                        ...
                        <div>
                            <label class="block text-xs font-bold text-gray-700 mb-1">Kamera Yang Digunakan (Bisa pilih > 1)</label>
            ...
            <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
                <h3 class="font-bold text-lg mb-4 text-yellow-700 border-b pb-2">A. Checklist Kelengkapan Dokumen & Folder</h3>
                <table class="w-full text-sm text-left border">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="p-3 border text-center"><input type="checkbox" name="chk_{{ $chk['id'] }}" value="1" {{ $qc->{'chk_'.$chk['id']} ? 'checked' : '' }} class="rounded border-gray-300 text-yellow-600 h-5 w-5"></td>
            ...
            <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
                <h3 class="font-bold text-lg mb-4 text-yellow-700 border-b pb-2">B. Poin Pengecekan Kualitas Data (Max 2MB/file)</h3>
                <div class="space-y-4">
                    @php
                        $uploads = [
            ...
            <div class="flex justify-end">
                <button type="submit" class="bg-yellow-600 text-white px-6 py-3 rounded-md font-bold hover:bg-yellow-700 text-lg shadow-lg">Simpan Laporan QC LiDAR</button>
            </div>
        </form>
    </div>
</x-app-layout>
