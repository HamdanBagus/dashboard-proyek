                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <textarea name="client_address" rows="3" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50">{{ old('client_address', $project->client_address) }}</textarea>
                                </div>

                                <div>
                                    <label class="block text-sm font-medium text-gray-700">Lokasi Proyek</label>
                                    <textarea name="project_location" rows="3" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50">{{ old('project_location', $project->project_location) }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="space-y-6">
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <select name="status" required class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50 text-base font-bold text-gray-800 bg-gray-50">
