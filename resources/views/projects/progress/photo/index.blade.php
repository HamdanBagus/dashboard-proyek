            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <div class="flex flex-col md:flex-row items-center justify-between bg-indigo-50 p-6 sm:p-8 rounded-2xl border border-indigo-100 shadow-inner">
                    <div class="flex-1 mb-6 md:mb-0 md:pr-8 text-center md:text-left">
                        <h4 class="text-2xl font-extrabold text-indigo-900 mb-2">Total Laporan Foto Udara</h4>
                            ...
                            <tr class="hover:bg-gray-50 transition">
                                ...
                                <td class="px-6 py-4 text-center whitespace-nowrap">
                                    <div class="flex justify-center items-center gap-2">
                                        ...
                                        <form action="{{ route('photo-hamparans.destroy', $hamparan->id) }}" method="POST" onsubmit="return confirm('Yakin menghapus hamparan ini beserta log di dalamnya?');">
                                            @csrf
                                            @method('DELETE')
