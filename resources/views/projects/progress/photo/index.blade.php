                            ...
                            <tr class="hover:bg-gray-50 transition">
                                ...
                                <td class="px-6 py-4 text-center whitespace-nowrap">
                                    <div class="flex justify-center items-center gap-2">
                                        <a href="{{ route('photo-hamparans.show', $hamparan->id) }}" class="bg-indigo-100 text-indigo-800 px-3 py-1.5 rounded text-xs font-bold hover:bg-indigo-200 border border-indigo-200 transition">
                                            Buka Detail
                                        </a>
                                        <form action="{{ route('photo-hamparans.destroy', $hamparan->id) }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus hamparan ini beserta seluruh log progress di dalamnya?');">
                                            @csrf
                                            @method('DELETE')
                                    ...
                                    <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                            ...
                                            <div class="md:col-span-2">
                                                ...
                                                <input type="text" name="location" :value="selectedOutput?.location" placeholder="D:\Project\... atau https://..." class="block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 sm:text-sm">
                                            </div>
