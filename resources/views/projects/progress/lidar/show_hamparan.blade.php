    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6 flex flex-col md:flex-row justify-between items-center gap-6">
                ...
                <div class="flex items-center gap-4 bg-gray-50 p-4 rounded-xl border border-gray-100 shadow-sm">
                    <div class="text-right">
                        ...
                        <p class="text-sm font-medium text-gray-800">Penyelesaian Area Ini</p>
                    </div>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6 mb-12">
                <h3 class="text-lg font-bold mb-4 text-green-700">Output Produk LiDAR (Deliverables)</h3>

                <div class="mb-6 bg-green-50 p-4 rounded border border-green-200">
                    <form action="{{ route('lidar-outputs.store', $hamparan->id) }}" method="POST" class="flex gap-4 items-end">
                        @csrf
                        <div class="flex-1">
                                    ...
                                    <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                            ...
                                            <div>
                                                ...
                                                <input type="text" name="format" list="lidar_format_file_modal" :value="selectedOutput?.format == '-' ? '' : selectedOutput?.format" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 sm:text-sm" required>
                                            ...
                                            <div class="md:col-span-2">
                                                <label class="block text-xs font-bold text-gray-600 mb-1">Lokasi Penyimpanan</label>
                                            ...
                                            <div class="md:col-span-2 mt-2 p-3 bg-gray-50 border rounded flex justify-between items-center">
                                                <label class="block text-sm font-bold text-gray-700">Status Ketersediaan</label>
