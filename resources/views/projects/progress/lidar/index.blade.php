        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 text-center">
                                    <div class="flex justify-center gap-2">
                                        <a href="{{ route('lidar-hamparans.show', $hamparan->id) }}" class="bg-green-100 text-green-800 px-3 py-1 rounded-full text-xs font-bold hover:bg-green-200">
                                            Buka Detail Progress
                                        </a>

                                        <form action="{{ route('lidar-hamparans.destroy', $hamparan->id) }}" method="POST" onsubmit="return confirm('Hapus hamparan ini?');">
                                            @csrf
                                            @method('DELETE')
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <div class="mb-6 bg-green-50 p-4 rounded border border-green-100">
                    <form action="{{ route('lidar-outputs.store', $report->id) }}" method="POST" class="grid grid-cols-1 md:grid-cols-5 gap-4 items-end">
                        @csrf
                        <div class="md:col-span-2">
                            ...
                            <select name="filename" class="block w-full rounded-md border-gray-300 shadow-sm sm:text-sm">
                                ...
                                <option value="Point Cloud">Kontur</option>
                                <option value="Tiling">Peta Kontur</option>
                            </select>
                        </div>
                        <div>
