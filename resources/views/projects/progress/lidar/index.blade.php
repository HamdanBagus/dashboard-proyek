    ...
    <div class="pt-6 pb-12 max-w-9xl mx-auto sm:px-6 lg:px-8 space-y-6">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
            ...
            <div class="lg:col-span-2 bg-white overflow-hidden shadow-sm sm:rounded-xl p-6 border border-gray-200 h-full flex flex-col">
                ...
                <div class="flex flex-col md:flex-row items-center justify-between bg-[#E8F1F1] p-6 rounded-2xl border border-[#144C4D]/20 shadow-inner flex-1">
                    <div class="flex-1 mb-6 md:mb-0 md:pr-8 text-center md:text-left">
                        <h4 class="text-2xl font-black text-[#144C4D] mb-2">Total Laporan LiDAR</h4>
            ...
            <div class="lg:col-span-1 bg-white overflow-hidden shadow-sm sm:rounded-xl p-6 border border-gray-200 h-full flex flex-col">
                ...
                <form action="{{ route('lidar-reports.update', $report->id) }}" method="POST" class="flex flex-col flex-1">
                    @csrf @method('PUT')
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-xl border border-gray-200">
            ...
            <div class="bg-gray-50 p-6 border-b border-gray-200">
                ...
                <form action="{{ route('lidar-hamparans.store', $report->id) }}" method="POST" class="grid grid-cols-1 md:grid-cols-12 gap-4 items-end bg-white p-5 rounded-xl border border-gray-100 shadow-sm">
                    @csrf
                        ...
                        <tr class="hover:bg-gray-50 transition">
                            ...
                            <td class="px-6 py-4 text-center whitespace-nowrap">
                                <div class="flex justify-center items-center gap-2">
                                    <a href="{{ route('lidar-hamparans.show', $hamparan->id) }}" class="text-[#144C4D] bg-[#E8F1F1] hover:bg-[#144C4D] hover:text-white px-3 py-1.5 rounded-lg text-xs font-bold border border-[#144C4D]/20 transition flex items-center gap-1.5 shadow-sm" title="Buka Detail">
                                    ...
                                    <form action="{{ route('lidar-hamparans.destroy', $hamparan->id) }}" method="POST" onsubmit="return confirm('Yakin menghapus hamparan ini beserta log tahapan dan output di dalamnya?');" class="inline-block">
                                        @csrf @method('DELETE')
